...
object GeminiClient {
    ...
    // Set at runtime from DataStore; takes precedence over build-time key
    var runtimeApiKey: String? = null

    private fun getEffectiveKey(): String {
        return runtimeApiKey?.takeIf { it.isNotBlank() }
    ...
    /**
     * Checks if the Gemini API Key is configured (runtime or build-time).
     */
